...
#define RECFN_CMSETUP      "setupCM"             // setupCM(plot_id, xMin, xMax, yMin, yMax, xSize, ySize, show=True)
#define RECFN_CMSHOW       "showColormap"        // showColormap(show=True)
